describe('Registraion for Jpetstore', () =>{
    ...
    cy.xpath('/html/body/div[2]/div/form/table[1]/tbody/tr[1]/td[2]/input').type('Niti'+ unique_id);
    cy.xpath('/html/body/div[2]/div/form/table[1]/tbody/tr[2]/td[2]/input').type('Password123'+unique_id);
    ...
    cy.xpath('/html/body/div[2]/div/form/table[2]/tbody/tr[1]/td[2]/input').type('Niti'+ unique_id);
