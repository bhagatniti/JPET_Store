describe('Registraion for Jpetstore', () =>{
    ...
    const user_name = 'Niti' + unique_id
    const email = 'abc'+unique_id+'@gmail.com'
    const phone = '989628'+ unique_id

    //User Information
    cy.xpath('/html/body/div[2]/div/form/h3[1]').should('have.text', 'User Information');
    cy.xpath('/html/body/div[2]/div/form/table[1]/tbody/tr[1]/td[2]/input').type(user_name);
    ...
    cy.xpath('/html/body/div[2]/div/form/table[2]/tbody/tr[1]/td[2]/input').type(user_name);
    cy.xpath('/html/body/div[2]/div/form/table[2]/tbody/tr[2]/td[2]/input').type('Bhagat');
    cy.xpath('/html/body/div[2]/div/form/table[2]/tbody/tr[3]/td[2]/input').type(email);
    cy.xpath('/html/body/div[2]/div/form/table[2]/tbody/tr[4]/td[2]/input').type(phone);
...
//Profile Information
    ...
    cy.wait(2000);
    cy.get('#Catalog > form > table:nth-child(6) > tbody > tr:nth-child(2) > td:nth-child(2) > select').select('DOGS');
    cy.wait(2000);
